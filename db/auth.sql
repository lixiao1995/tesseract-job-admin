...
VALUES (1, 'add', '添加', 1, 'admin', 1, 'admin', NULL, 1563608954787, 1563608954787);
INSERT INTO `tesseract_btn_resource`
VALUES (2, 'edit', '编辑', 1, 'admin', 1, 'admin', NULL, 1563609045332, 1563609045332);
INSERT INTO `tesseract_btn_resource`
VALUES (3, 'delete', '删除', 1, 'admin', 1, 'admin', NULL, 1563609177143, 1563609177143);
INSERT INTO `tesseract_btn_resource`
VALUES (4, 'select', '查询', 1, 'admin', 1, 'admin', NULL, 1563609314272, 1563609314272);
