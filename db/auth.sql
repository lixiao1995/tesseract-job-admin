...
VALUES (1, 'add', '/permission/add', '添加', 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tesseract_btn_resource`
VALUES (2, 'edit', '/permission/edit', '编辑', 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
VALUES (1, 'Permission', 0, '/permission/page', 'permission', '', 'lock', 1, '', 5, 1, 'admin', 1, 'admin', 0, NULL,
        NULL, 0, 1);
INSERT INTO `tesseract_menu_resource`
VALUES (2, 'PagePermission', 1, NULL, 'page', '', 'example', 2, '', 1, 1, 'admin', 1, 'admin', 0, NULL, NULL, 0, 1);
INSERT INTO `tesseract_menu_resource`
VALUES (3, 'DirectivePermission', 1, NULL, 'directive', '', 'example', 2, '', 2, 1, 'admin', 1, 'admin', 0, NULL, NULL,
        0, 1);
INSERT INTO `tesseract_menu_resource`
VALUES (4, 'RolePermission', 1, NULL, 'role', '', 'example', 2, '', 3, 1, 'admin', 1, 'admin', 0, NULL, NULL, 0, 1);
INSERT INTO `tesseract_menu_resource`
VALUES (5, 'Icon', 0, NULL, 'icons', '', NULL, 1, '', 1, 1, 'admin', 1, 'admin', 0, NULL, NULL, 0, 1);
INSERT INTO `tesseract_menu_resource`
VALUES (6, 'Icons', 5, NULL, 'index', '', NULL, 2, '', 1, 1, 'admin', 1, 'admin', 0, NULL, NULL, 0, 1);
INSERT INTO `tesseract_menu_resource`
VALUES (7, 'Example', 0, '/example/list', 'example', '', 'example', 1, '', 1, 1, 'admin', 1, 'admin', 0, NULL, NULL, 0,
        1);
INSERT INTO `tesseract_menu_resource`
VALUES (8, 'CreateArticle', 7, NULL, 'create', '', 'edit', 2, '', 1, 1, 'admin', 1, 'admin', 0, NULL, NULL, 0, 1);
INSERT INTO `tesseract_menu_resource`
VALUES (9, 'EditArticle', 7, NULL, 'edit', '', 'edit', 2, '', 2, 1, 'admin', 1, 'admin', 0, NULL, NULL, 0, 1);
INSERT INTO `tesseract_menu_resource`
VALUES (10, 'ArticleList', 7, NULL, 'list', '', 'list', 2, '', 3, 1, 'admin', 1, 'admin', 0, NULL, NULL, 0, 1);
INSERT INTO `tesseract_menu_resource`
VALUES (11, '触发器', 0, '/trigger/index', 'trigger', '', 'example', 1, '', 1, 1, 'admin', 1, 'admin', 0, NULL, NULL, 0,
        1);
INSERT INTO `tesseract_menu_resource`
VALUES (12, '触发器列表', 11, '', 'index', '', 'documentation', 2, '', 1, 1, 'admin', 1, 'admin', 0, NULL, NULL, 0, 1);
INSERT INTO `tesseract_menu_resource`
VALUES (13, '用户', 0, '/user/index', 'user', '', 'example', 1, '', 2, 1, 'admin', 1, 'admin', 0, NULL, NULL, 0, 1);
INSERT INTO `tesseract_menu_resource`
VALUES (14, '用户列表', 13, NULL, 'index', '', 'documentation', 2, '', 1, 1, 'admin', 1, 'admin', 0, NULL, NULL, 0, 1);
INSERT INTO `tesseract_menu_resource`
VALUES (15, '日志', 0, '/log/index', 'log', '', 'example', 1, '', 4, 1, 'admin', 1, 'admin', 0, NULL, NULL, 0, 1);
INSERT INTO `tesseract_menu_resource`
VALUES (16, '日志列表', 15, NULL, 'index', '', 'documentation', 2, '', 1, 1, 'admin', 1, 'admin', 0, NULL, NULL, 0, 1);

INSERT INTO `tesseract_menu_resource`(id, name, parent_id, redirect, path, url_pattern, icon, level, menu_desc,
...
VALUES (18, '执行器列表', 0, NULL, '/executor/index', '', 'documentation', 2, '', 1, 1, 'admin', 1, 'admin', 0, NULL, NULL, 0, 1);

INSERT INTO `tesseract_menu_resource`(id, name, parent_id, redirect, path, url_pattern, icon, level, menu_desc,
                                      menu_order, create_user_id, create_user_name, update_user_id, update_user_name,
                                      status, create_time, update_time, del_flag, always_show_flag)

VALUES (19, '权限管理', 0, '/permission-new/menuResource/index', '/permission-new/menuResource/index', '', 'documentation',
        2, '', 1, 1, 'admin', 1,
        'admin', 0, NULL, NULL, 0, 1);
INSERT INTO `tesseract_menu_resource`
VALUES (20, '菜单管理', 19, NULL, 'index', '', 'documentation', 2, '', 1, 1, 'admin', 1, 'admin', 0, NULL, NULL, 0, 1);
...
INSERT INTO `tesseract_role`
VALUES (1, 'admin', 'admin123', '超级管理员', 1, 'admin', 1, 'admin', 0, 0, NULL, NULL);
INSERT INTO `tesseract_role`
VALUES (2, NULL, 'manager', '经理', 1, 'admin', 1, 'admin', 0, 0, NULL, NULL);
...
VALUES (9, 1, 8, 7, NULL);
INSERT INTO `tesseract_role_resources`
VALUES (10, 1, 9, 7, NULL);
INSERT INTO `tesseract_role_resources`
VALUES (11, 1, 10, 7, NULL);
INSERT INTO `tesseract_role_resources`
VALUES (12, 1, 11, 0, NULL);
INSERT INTO `tesseract_role_resources`
VALUES (13, 1, 12, 11, NULL);
INSERT INTO `tesseract_role_resources`
VALUES (14, 1, 13, 0, NULL);
INSERT INTO `tesseract_role_resources`
VALUES (15, 1, 14, 13, NULL);
INSERT INTO `tesseract_role_resources`
VALUES (16, 1, 15, 0, NULL);
INSERT INTO `tesseract_role_resources`
VALUES (17, 1, 16, 15, NULL);
INSERT INTO `tesseract_role_resources`
VALUES (18, 1, 17, 0, NULL);
INSERT INTO `tesseract_role_resources`
VALUES (19, 1, 18, 17, NULL);
INSERT INTO `tesseract_role_resources`
VALUES (20, 1, 19, 0, NULL);
INSERT INTO `tesseract_role_resources`
VALUES (21, 1, 20, 19, NULL);
