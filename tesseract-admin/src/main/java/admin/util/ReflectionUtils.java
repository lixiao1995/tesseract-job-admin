...
public class ReflectionUtils {
    ...
    public static Object converseType(Object param, Class<?> paramClass) {
        ...
        // 基本数据类型
        if (param instanceof java.lang.String && String.class.equals(paramClass)) {
            return (String)param;
        }

        if (param instanceof java.lang.Byte && Byte.TYPE.getClass().equals(paramClass)) {
            return (Byte)param;
        }
        if (param instanceof java.lang.Short && Short.TYPE.getClass().equals(paramClass)) {
            return (Short)param;
        }

        if (param instanceof java.lang.Integer && Integer.TYPE.getClass().equals(paramClass)) {
            return (Integer)param;
        }
        if (param instanceof java.lang.Long && Long.TYPE.getClass().equals(paramClass)) {
            return (Long)param;
        }
        if (param instanceof java.lang.Float && Float.TYPE.getClass().equals(paramClass)) {
            return (Float)param;
        }
        if (param instanceof java.lang.Double && Double.TYPE.getClass().equals(paramClass)) {
            return (Double)param;
        }
        if (param instanceof java.lang.Boolean && Boolean.TYPE.getClass().equals(paramClass)) {
